    ...
    async (req, res, next) => {
        ...
        const line_items = body?.orderItems?.map((item) => {
            return {
                ...
                tax_rates: ["txr_1PLc6ZRx1MID7VUPjSBj0tiN"],
        ...
        const shipping_rate = body?.itemsPrice >= 200 ? "shr_1PLbsBRx1MID7VUPFoFyEAMh" : "shr_1PLbuRRx1MID7VUPWJB4yRRr";
